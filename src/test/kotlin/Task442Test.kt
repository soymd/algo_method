...
class Task442Test {
    ...
    fun main() {
        ...
        val smaller = list.filter { it <= index }.sorted()
        val bigger = list.filter { index < it }.sorted()

        val ans = smaller + bigger
    ...
    fun a_1() {
        ...
        assertThat(result, equalTo(listOf("1 1 2 3 4")))
    }

    @Test
    fun a_2() {
        input.inputln("10")
        input.inputln("3 1 4 1 5 9 2 6 5 3")

        main()

        val result = output.readLines()
        assertThat(result, equalTo(listOf("1 1 2 3 3 4 5 5 6 9")))
    }
